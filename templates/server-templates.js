...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "\";\n    header.useMongo = ";
  foundHelper = helpers.useMongo;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.useMongo; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + ";\n    header.allowedOrigins = JSON.parse( '";
  foundHelper = helpers.allowedOrigins;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.allowedOrigins; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  if(stack1 || stack1 === 0) { buffer += stack1; }
